<nav class="bg-white shadow p-4">
    ...
    <div class="flex justify-between items-center">
        <div class="flex items-center content-center gap-1">
            ...
            alt="Eclair"></a>
        <h1 class="font-bold text-xl pt-3">Techcorp</h1>
        <button id="burger" class="lg:hidden text-2xl">
            ☰
        </button>
        ...
        <div class="hidden lg:flex gap-4 items-center">
            <button><img class="h-8 w-8" src="./Asset/lune.png"></button>
            <button><img class="h-8 w-8" src="./Asset/notification.png"></button>
            <button><img class="h-8 w-8" src="./Asset/parametre.png"></button>
